...
Es por esto que necesitamos utilizar la división entera, no sirve la división estándar.
...
![](https://raw.githubusercontent.com/GabrielCourses/matematicas_discretas/main/sist_numericos/image/entero.png)

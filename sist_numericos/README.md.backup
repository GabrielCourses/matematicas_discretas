...
Podemos ocupar el algoritmo de la división para comprobar nuestros resultados. Dado cualquier número b $\in{Z}$ podemos encontrar un par de números $p,q\in{Z}$ que sumado otro número que está entre 0 y p es igual a **b.**
